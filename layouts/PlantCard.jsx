              ...
              <MenuOptions
                ...
                <View className="border-[#888888] border-4 rounded-3xl">
                  <MenuOption
                    ...
                    <Text className="text-center text-[#212121]">{strings.edit_pc}</Text>
                  </MenuOption>
                  <MenuOption
                    className="border-[#888888] border-b-2"
                    onSelect={() => alert(`Share`)}>
                    <Text className="text-center text-[#212121]">{strings.share_gc}</Text>
                  </MenuOption>
                  <MenuOption onSelect={() => handleDelete(plant.id, onUpdate)}>
                    <Text className="text-center text-[#C04444]">{strings.delete_gc}</Text>
                  </MenuOption>
                </View>
              </MenuOptions>
            </Menu>
